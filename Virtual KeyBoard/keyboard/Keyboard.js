const Keyboard = {
    ...
    _createKeys() 
    {
        const fragment = document.createDocumentFragment(); // it acts like a Jlabel in java
        const keyLayout = [
            "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "backspace",             // structure of keyboard with keys
            "q", "w", "e", "r", "t", "y", "u", "i", "o", "p",
                ...
                case "backspace" :
                    ...
                    case "caps" :
                        ...
                        keyElement.addEventListener("click", () => {
                            ...
                            keyElement.classList.toggle("keyboard__key--active", this.properties.capsLock);   // class toggle and propeties toggle
                        });
                        break;
